      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center py-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <button
              className={`px-4 py-2 rounded transition-colors bg-purple-600`}
            >
              Students
            </button>
            <Link to="/leaderboard">
                ...
                {filteredStudents.length > 0 ? (
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <button
                        onClick={resetFilters}
                        className="mt-2 text-white hover:text-purple-300 underline"
                      >
                        Reset Filters
                      </button>
                    </td>
          ...
          <div className="bg-[#1E1E1E] border-2 border-purple-800 rounded-lg p-6 w-full max-w-lg shadow-2xl">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-[#0F0F0F] border border-purple-700 rounded p-2"
                />
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full bg-[#0F0F0F] border border-purple-700 rounded p-2">
                    {YEARS.filter((year) => year !== "All Years").map(
                      (year) => (
                        <option key={year} value={year}>
                          {year}
                        </option>
              ...
              <div>
                ...
                <select className="w-full bg-[#0F0F0F] border border-purple-700 rounded p-2">
                  {DEPARTMENTS.filter((dept) => dept !== "All Departments").map(
                    (dept) => (
                      <option key={dept} value={dept}>
                        {dept}
                      </option>
