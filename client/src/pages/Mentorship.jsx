        ...
        {filteredMentors.map((mentor) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              >
                {isTeacher ? "You are a teacher" : "Request Mentorship"}
              </button>
            </div>
          </div>
        ))}
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full bg-[#2C2C2C] text-white px-4 py-2 pl-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
              />
